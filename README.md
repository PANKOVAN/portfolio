...
[По этой ссылке](https://pankovan.github.io/C4/viewer/) можно посмотреть примеры диаграмм C4 подготовленные для вставки в ТЗ.

<script type="module" src="https://pankovan.github.io/C4/viewer/likec4-views.js"></script>

<likec4-view view-id="index" browser="true" dynamic-variant="sequence"></likec4-view>

***Рисунок 4 –Взаимодействие подсистем КИ-Ц САИ ПС.ИНП со смежными системами***

Примеры экранов

![Сервисное обслуживания (СО) оборудования установленного на местах](bpmn-kic-1.svg)

***Пример использования диаграмм BPMN***

![Пример использования Sequece Diagramm для иллюстрации разбора BIN сообщений](bin-wsdl.svg)

***Пример использования Sequece Diagramm для иллюстрации разбора BIN сообщений***
