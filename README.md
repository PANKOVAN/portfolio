...
[Здесь можно посмотреть на пример использования диаграмм C4 при разработке](https://pankovan.github.io/C4/)
...
**Стек:** NODE JS, JavaScript, PostgreSQL, Express, HTML, CSS, D3
